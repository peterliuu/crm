...
def distribute_permissions(request):
	...
	"""
	# 获取所有用户
	all_user_lists = models.UserInfo.objects.all()
	# 获取所有角色
	...
	'''
	all_permission_list = models.Permission.objects.filter(menu_id__isnull=True, pid_id__isnull=False).values("id", "title", "pid_id")
