    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(help_text='违纪扣分写负值，表现优异加分写正值', verbose_name='分值')),
        ...
        migrations.AddField(
            ...
            name='class_teacher',
            field=models.ForeignKey(limit_choices_to={'depart__title': '教质部'}, on_delete=django.db.models.deletion.CASCADE, related_name='user_class', to='web.UserInfo', verbose_name='班主任'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
        ...
        migrations.AddField(
            model_name='classlist',
            name='tech_teacher',
            field=models.ManyToManyField(blank=True, limit_choices_to={'depart__title__in': ['Python教学部', 'Linux教学部']}, related_name='teacher_user', to='web.UserInfo', verbose_name='任课老师'),
        ),
    ]
