...
class ClassList(models.Model):
	...
	class_teacher = models.ForeignKey(verbose_name="班主任", to='UserInfo', on_delete=models.CASCADE,
									  related_name="user_class", limit_choices_to={"depart__title": "教质部"})
	tech_teacher = models.ManyToManyField(verbose_name="任课老师", to="UserInfo", related_name="teacher_user",
										  blank=True, limit_choices_to={"depart__title__in": ["Python教学部", "Linux教学部"]})
...
class Customer(models.Model):
	...
	consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultant',
								   ...
								   limit_choices_to={'depart__title': '销售部'}, on_delete=models.CASCADE)  # 必须是销售部人员
	education_choices = (
		(1, '重点大学'),
		(2, '普通本科'),
		(3, '独立院校'),
...
class CourseRecord(models.Model):
	...
	day_num = models.IntegerField(verbose_name="天数")
